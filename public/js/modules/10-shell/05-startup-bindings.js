...
initIdleGuideCanvas();
var startupLoginStatusPromise = Promise.all([refreshLoginStatus(), refreshQQLoginStatus({ forceVip: true, reason: 'startup' }), refreshKugouLoginStatus(), refreshQishuiLoginStatus(), refreshSpotifyLoginStatus(), refreshAppleLoginStatus(), persistedLocalLibraryRestorePromise]);
...
startAppleLoginStatusAutoRefresh();
